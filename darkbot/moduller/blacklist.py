...
from darkbot import CMD_HELP, bot, LOGS
...
async def blacklist_init():
    try:
        global sql
        sql = import_module("darkbot.moduller.sql_helper.blacklist_sql")
    except:
        sql = None
...
@darkify(outgoing=True, pattern="^.addblacklist")
...
@darkify(outgoing=True, pattern="^.showblacklist")
