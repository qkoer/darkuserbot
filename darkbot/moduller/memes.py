...
# ===========================================
@darkify(outgoing=True, pattern=r"^.(\w+)say")
...
@darkify(outgoing=True, pattern="^:/$", ignore_unsafe=True)
async def kek(keks):
...
@darkify(pattern="^.slap", outgoing=True)
async def who(event):
...
async def slap(replied_user, event):
    ...
    caption = "dark, " + temp.format(
        victim=slapped, item=item, hits=hit, throws=throw)

    return caption

@darkify(outgoing=True, pattern="^-_-$", ignore_unsafe=True)
async def lol(lel):
    """ Tamam... """
    okay = "-_-"
    for i in range(10):
...
@darkify(outgoing=True, pattern="^.fp$")
async def facepalm(e):
    """ Utanmak  🤦‍♂ """
    await e.edit("🤦‍♂")

@darkify(outgoing=True, pattern="^.cry$")
async def cry(e):
    """ bunu yaparsan, her zaman ağlarım !! """
    await e.edit(choice(CRI))

@darkify(outgoing=True, pattern="^.cp")
...
@darkify(outgoing=True, pattern="^.vapor")
async def vapor(vpr):
...
@darkify(outgoing=True, pattern="^.str")
...
@darkify(outgoing=True, pattern="^.zal")
async def zal(zgfy):
...
@darkify(outgoing=True, pattern="^.shout")
async def shout(sht):
...
@darkify(outgoing=True, pattern="^.hi$")
async def hoi(hello):
    """ Herkesi selamlayın """
    await hello.edit(choice(HELLOSTR))

@darkify(outgoing=True, pattern="^.owo")
async def faces(owo):
    """ UwU """
...
@darkify(outgoing=True, pattern="^.react$")
async def react_meme(react):
    """ UserBot'un her şeye tepki vermesini sağlayın. """
    await react.edit(choice(FACEREACTS))

@darkify(outgoing=True, pattern="^.shg$")
async def shrugger(shg):
    r""" ¯\_(ツ)_/¯ """
    await shg.edit(choice(SHGS))

@darkify(outgoing=True, pattern="^.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))

@darkify(outgoing=True, pattern="^[Oo]of$")
async def oof(e):
    t = f"{e.text[0]}of"
    for j in range(16):
        t = f"{t[:-1]}of"
...
@darkify(outgoing=True, pattern="^[Ss]krrt$")
async def skrrt(e):
    t = f"{e.text[0]}krrt"
    for j in range(16):
        t = f"{t[:-1]}rt"
...
@darkify(outgoing=True, pattern="^.kalp")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.10iq$")
async def iqless(e):
    await e.edit(
...
@darkify(outgoing=True, pattern="^.mizah$")
...
@darkify(outgoing=True, pattern="^.moon$")
...
@darkify(outgoing=True, pattern="^.clock$")
...
@darkify(outgoing=True, pattern="^.mock")
...
@darkify(outgoing=True, pattern="^.clap")
...
@darkify(outgoing=True, pattern=r"^.f (.*)")
...
@darkify(outgoing=True, pattern="^.lfy")
...
@darkify(pattern=r".scam", outgoing=True)
...
@darkify(outgoing=True, pattern='^.type')
...
@darkify(outgoing=True, pattern="^.hava$")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.d[uü]nya$")
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
...
@darkify(outgoing=True, pattern="^.d[uü][sş][uü]nme$")
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🤔🧐🤔🧐🤔🧐"))
...
@darkify(outgoing=True, pattern="^.y[ıi]lan$")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.(solar|g[uü]ne[sş])$")
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@darkify(outgoing=True, pattern="^.şehir")
...
@darkify(outgoing=True, pattern="^.(lmoon|ay)")
async def lmoon(event):
    if event.fwd_from:
        return 
    await event.edit("🌕🌕🌕🌕🌕🌕🌕🌕\n🌕🌕🌖🌔🌖🌔🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌖🌓🌗🌔🌕🌕\n🌕🌕🌗🌑🌑🌓🌕🌕\n🌕🌕🌗👀🌑🌓🌕🌕\n🌕🌕🌘👄🌑🌓🌕🌕\n🌕🌕🌗🌑🌑🌒🌕🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌕🌘🌑🌑🌑🌑🌒🌕\n🌖🌑🌑🌑🌑🌑🌑🌔\n🌕🤜🏻🌑🌑🌑🌑🤛🏻🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌘🌑🌑🌑🌑🌑🌑🌒\n🌕🌕🌕🌕🌕🌕🌕🌕")
    
@darkify(outgoing=True, pattern="^.k[uü][cç][uü]lme")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.nasa")
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
