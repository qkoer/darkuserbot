...
@darkify(outgoing=True, pattern="^.saniye$")
async def saniye(sanisim):
    await sanisim.edit(choice(SANIYE_STRINGS))

@darkify(outgoing=True, pattern="^.saniş$")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.snş$")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.naytsaniş$")
async def _(event):
    if event.fwd_from:
        return
...
@darkify(outgoing=True, pattern="^.❤️$")
