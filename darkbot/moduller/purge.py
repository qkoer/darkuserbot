...
@darkify(outgoing=True, pattern="^.purge$")
...
@darkify(outgoing=True, pattern="^.purgeme")
...
@darkify(outgoing=True, pattern="^.del$")
...
@darkify(outgoing=True, pattern="^.edit")
...
@darkify(outgoing=True, pattern="^.sd")
