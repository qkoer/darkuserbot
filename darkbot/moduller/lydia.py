...
from darkbot import CMD_HELP, LOGS, LYDIA_API_KEY

async def lydia_init():
    try:
        from darkbot.moduller.sql_helper.lydia_sql import get_s, get_all_s, add_s, remove_s
    except:
...
@darkify(outgoing=True, pattern="^.repcf")
...
@darkify(outgoing=True, pattern="^.addcf")
...
@darkify(outgoing=True, pattern="^.remcf")
