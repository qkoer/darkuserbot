...
for module_name in ALL_MODULES:
    try:
        ...
        import_module("darkbot.moduller." + module_name)
...
LOGS.info("Botunuz çalışıyor! Herhangi bir sohbete .alive yazarak Test edin."
          " Yardıma ihtiyacınız varsa, Destek grubumuza gelin https://telegram.me/karanliksohbet")
LOGS.info("Bot sürümünüz DarK v3.4")
